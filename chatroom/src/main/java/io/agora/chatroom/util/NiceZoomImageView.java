...
public class NiceZoomImageView extends ZoomInImageView {
    ...
    public NiceZoomImageView(Context context) {
        this(context, null);
    }

    public NiceZoomImageView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public NiceZoomImageView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
