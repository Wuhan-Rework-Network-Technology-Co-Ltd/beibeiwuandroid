...
public class MusicPlayer extends IRtcEngineEventHandler {
    ...
    public static volatile MemberMusicModel mMusicModel;
...
//        mAudioTracksCount = mRtcEngine.getAudioTrackCount();
    ...
    public void onStreamMessage(int uid, int streamId, byte[] data) {
        ...
        try {
            ...
            Log.d(TAG, "onStreamMessage: 接收歌词同步消息"+jsonMsg);
            //接收演唱者的停止通知
            if (jsonMsg.getString("cmd").equals("musicStopped")) {
            ...
            if (jsonMsg.getString("cmd").equals("setLrcTime")) {
                ...
                if (position == 0) {
                    ...
                    bundle.putString("songId", mMusicModel.getSongId());
