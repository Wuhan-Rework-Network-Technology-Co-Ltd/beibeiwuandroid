...
public class FollowAndFansActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menuViewPagerView_fragment.add(FollowOrFansFragment.newInstance(getIntent().getStringExtra("userId"),"关注"));
        menuViewPagerView_fragment.add(FollowOrFansFragment.newInstance(getIntent().getStringExtra("userId"),"粉丝"));

        menuViewPagerView_menu.add("关注");
        menuViewPagerView_menu.add("粉丝");
