...
import xin.banghua.beiyuan.publish.ScriptEffectActivity;

public class ScriptCAdapter extends RecyclerView.Adapter<ScriptCAdapter.ViewHolder>{
    ...
    Context mContext;
    public ScriptCAdapter(List<ScriptList> scriptLists,Context mContext) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.script_c_item,parent,false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        //holder.script_layout.setLayoutParams(new ConstraintLayout.LayoutParams((Common.screen_width/2)-50,((Common.screen_width/2)-20)*1280/720));
        holder.script_layout.setOnClickListener(v -> {
            ...
            if (!(new File(oldPath)).exists()) { // 如果不存在.
                ...
                Common.downloadAttachment("Video", "script"+currentItem.getId(), Common.getOssResourceUrl(currentItem.getScript_video()), task -> {
                    ...
                    Intent intent = new Intent(mContext, ScriptEffectActivity.class);
        ...
        holder.script_times.setText(currentItem.getScript_times()+"人使用");
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            script_times = itemView.findViewById(R.id.script_times);
