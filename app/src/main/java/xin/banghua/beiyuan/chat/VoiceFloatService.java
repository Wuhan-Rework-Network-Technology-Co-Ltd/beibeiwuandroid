...
public class VoiceFloatService extends Service implements RtcEngineEventHandler {
    public static final String FROM_VOICE_SERVICE = "VoiceFloatService";

    private static final String TAG = "VoiceFloatService";
...
//        Log.d(TAG, "run:CommonKtv.audioroom:"+CommonKtv.audioroom);
    ...
    private void initWindow() {
        ...
        // 获取浮动窗口视图所在布局
        mFloatingLayout = inflater.inflate(R.layout.service_float_voice, null);
    ...
    private void initFloating() {
        ...
        my_imgview.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(VoiceFloatService.this, VoiceChatViewActivity.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                intent.putExtra("channel", VoiceChatViewActivity.channel);
                intent.putExtra("targetId", VoiceChatViewActivity.targetId);
                intent.putExtra("targetPortrait", VoiceChatViewActivity.targetPortrait);
                intent.putExtra("myRole", VoiceChatViewActivity.myRole);
                intent.putExtra("from", FROM_VOICE_SERVICE);
    ...
    public void onUserJoined(int uid, int elapsed) {
        if (!Common.userInfoList.getId().equals(uid+"")){
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    userJoined = uid;
                    Toast.makeText(VoiceFloatService.this,"匹配成功！",Toast.LENGTH_SHORT).show();
                    SoundUtil.getInstance(VoiceFloatService.this).playSoundLoop(SoundUtil.SOUND_LOVE_BELL);
                    OkHttpInstance.getUserAttributes(uid+"", new OkHttpResponseCallBack() {
                        ...
                        public void getResponseString(String responseString) {
                            ...
                            VoiceChatViewActivity.targetId = userInfoList.getId();
                            VoiceChatViewActivity.targetPortrait = userInfoList.getPortrait();
                        }
                    });
                }
            });
