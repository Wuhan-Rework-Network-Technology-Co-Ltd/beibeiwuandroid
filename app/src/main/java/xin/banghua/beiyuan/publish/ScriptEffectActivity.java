 ...
 * Created on 2021/3/1
 */
public class ScriptEffectActivity extends ScriptFaceUnityActivity {
    private static final String TAG = "AllEffectActivity";


    public static ScriptEffectActivity allEffectActivity;
    //美颜
        ...
        if (isLeaveVideoChat){
            sticker_btn.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    finish();
                    Intent intent = new Intent(ScriptEffectActivity.this, ScriptEffectActivity.class);
