 ...
 * Created on 2021/3/1
 */
public class ScriptSingleEffectActivity extends ScriptSingleFaceUnityActivity {
    private static final String TAG = "AllEffectActivity";


    public static ScriptSingleEffectActivity allEffectActivity;
    //美颜
        ...
        if (isLeaveVideoChat){
            sticker_btn.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    finish();
                    Intent intent = new Intent(ScriptSingleEffectActivity.this, ScriptSingleEffectActivity.class);
