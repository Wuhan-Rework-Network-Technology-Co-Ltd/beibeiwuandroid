 ...
 * Use the {@link WealthAndGlamourFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class WealthAndGlamourFragment extends Fragment {
    ...
    public WealthAndGlamourFragment() {
     ...
     * @return A new instance of fragment WealthAndGlamourFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static WealthAndGlamourFragment newInstance(String param1, String param2) {
        WealthAndGlamourFragment fragment = new WealthAndGlamourFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_wealth_and_glamour, container, false);
    }
...
//                });
            ...
            public void onLoadMore() {
                ...
                OkHttpInstance.wealthAndGlamour(mParam1,pageIndex,mParam2, responseString -> {
                ...
                if (mParam1.equals("all_money")||mParam1.equals("all_income")){
                    OkHttpInstance.wealthAndGlamour(mParam1,pageIndex,mParam2, responseString -> {
                        if (!responseString.equals("false")){
                            userInfoLists.addAll(JSON.parseArray(responseString,UserInfoList.class));
                            exampleFragmentAdapter.swapData(userInfoLists);
                    ...
                    OkHttpInstance.tuijiannew(pageIndex, mParam2, new OkHttpResponseCallBack() {
                        @Override
                ...
                }else if (mParam1.equals("fujin")){
                    OkHttpInstance.fujinnew(pageIndex, mParam2, new OkHttpResponseCallBack() {
                        @Override
                        public void getResponseString(String responseString) {
                            if (!responseString.equals("false")){
                                userInfoLists.addAll(JSON.parseArray(responseString,UserInfoList.class));
    ...
    public void reloadData(String mParam2){
        if (mParam1.equals("all_money")||mParam1.equals("all_income")){
            OkHttpInstance.wealthAndGlamour(mParam1,pageIndex,mParam2, responseString -> {
                if (!responseString.equals("false")){
                    userInfoLists.clear();
