...
/*
用法 poi.setText(MapDistance.getDistance(Common.latitude,Common.longitude,currentItem.getLatitude(),currentItem.getLongitude())+"km");
 */
public class MapDistance {
    ...
    /**
     * System.out.println("测试地图距离2："+MapDistance.getDistance("31.14","118.22","30.40","120.52"));   234km
