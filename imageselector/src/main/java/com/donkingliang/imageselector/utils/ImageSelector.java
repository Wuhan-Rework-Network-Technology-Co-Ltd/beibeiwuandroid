...
public class ImageSelector {
    ...
    public static class ImageSelectorBuilder {
        ...
        private boolean onlyImage = false; //是否要图片
        private boolean onlyVideo = false; //是否要视频
         ...
         * 是否只要视频（不要视频）
         *
         * @param onlyVideo 默认为true
         * @return
         */
        public ImageSelectorBuilder onlyVideo(boolean onlyVideo) {
        ...
        public void start(Activity activity, int requestCode) {
            if (isCrop) {
                ...
                ImageSelectorActivity.openActivity(activity, requestCode,onlyImage,onlyVideo,isSingle, isViewImage,
        ...
        public void start(Fragment fragment, int requestCode) {
            if (isCrop) {
                ...
                ImageSelectorActivity.openActivity(fragment, requestCode, isSingle,onlyImage,onlyVideo, isViewImage,
                        useCamera, maxSelectCount,isTagging, selected);
            }
        }
