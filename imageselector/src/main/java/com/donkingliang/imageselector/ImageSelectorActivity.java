...
public class ImageSelectorActivity extends AppCompatActivity {
    ...
    public final static int IMAGE_SELECTOR_REQUEST_CODE = 1011;  //图片选择返回码
     ...
     * @param requestCode
     * @param isSingle       是否单选
     * @param onlyImage      是否要图片
     * @param onlyVideo      是否要视频
    ...
    public static void openActivity(Activity activity, int requestCode,
                                    boolean onlyImage,boolean onlyVideo,boolean isSingle, boolean isViewImage, boolean useCamera,
                                    int maxSelectCount,boolean isTagging, ArrayList<String> selected) {
        Intent intent = new Intent(activity, ImageSelectorActivity.class);
        intent.putExtras(dataPackages(isSingle,onlyImage,onlyVideo, isViewImage, useCamera, maxSelectCount,isTagging, selected));
    ...
    public static void openActivity(Fragment fragment, int requestCode,
                                    boolean isSingle,boolean onlyImage,boolean onlyVideo, boolean isViewImage, boolean useCamera,
                                    int maxSelectCount,boolean isTagging, ArrayList<String> selected) {
    ...
    public static Bundle dataPackages(boolean isSingle,boolean onlyImage,boolean onlyVideo, boolean isViewImage, boolean useCamera,
                                      int maxSelectCount,boolean isTagging, ArrayList<String> selected) {
        ...
        bundle.putBoolean(ImageSelector.ONLY_VIDEO, onlyVideo);
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        onlyVideo = intent.getBooleanExtra(ImageSelector.ONLY_VIDEO, false);
...
//            Toast.makeText(this, "没有图片", Toast.LENGTH_LONG).show();
    ...
    private void loadImageForSDCard() {
        Log.d(TAG, "loadImageForSDCard: 是否显示图片"+onlyImage+"是否显示视频"+onlyVideo);
        ImageModel.loadImageForSDCard(this, onlyImage,onlyVideo,new ImageModel.DataCallback() {
            @Override
