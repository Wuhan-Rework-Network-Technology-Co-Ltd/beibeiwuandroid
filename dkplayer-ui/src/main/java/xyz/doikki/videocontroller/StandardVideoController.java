...
public class StandardVideoController extends GestureVideoController implements View.OnClickListener {
     ...
     * @param isLive 是否为直播
     */
    public void addDefaultControlComponent(String title, boolean isLive, SeekBar.OnSeekBarChangeListener onSeekBarChangeListener) {
        ...
        if (isLive) {
            ...
            vodControlView.setOnSeekBarChangeListener(onSeekBarChangeListener);
     ...
     * @param isLive 是否为直播
     */
    public void addDefaultControlComponent(IControlComponent component, String title, boolean isLive, SeekBar.OnSeekBarChangeListener onSeekBarChangeListener) {
        CompleteView completeView = new CompleteView(getContext());
        ErrorView errorView = new ErrorView(getContext());
        PrepareView prepareView = new PrepareView(getContext());
        prepareView.setClickStart();
